 ...
 */
final class Version20210330123249 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        // $this->addSql('ALTER TABLE mileage ADD is_fit TINYINT(1) DEFAULT NULL, ADD min_km INT DEFAULT NULL, ADD max_km INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mileage DROP is_fit, DROP min_km, DROP max_km');
    }
}
